...
* (already implemented) `webrtc_bridge_local_node` - implements webrtc streaming for "local" mode,
...
* (TBD) `webrtc_bridge_remote_node` - designed for a remote use case, when browser and
